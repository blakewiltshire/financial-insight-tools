...
# -------------------------------------------------------------------------------------------------
"""
Commodity Markets & Pricing — Thematic Indicator Module
--------------------------------------------------------

This module provides a structured decision-support interface for analysing {short_description}.

This module provides a structured decision-support interface for analysing commodity market trends,
pricing dynamics, and supply-demand signals across key resource categories.

It focuses on:

- Energy, metals, and agricultural commodity price indices
- Volatility, terms of trade, and sectoral input cost trends
- Optional commodity-linked trade flows, inventory levels, or producer sentiment indicators
...
from indicator_map.indicator_map_900 import get_indicator_maps

from use_cases.use_case_900 import get_use_cases, render_use_case_selector

from insights.insight_900 import generate_econ_insights

from routing.routing_900 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_900_commodity_markets_pricing import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_900 import (
...
THEME = "commodity_markets_pricing"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "900"                # Theme ID
STRUCTURAL_FOLDER = "900_commodity_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Pricing trends across key commodities influencing inflation, trade, and sectoral exposure.*")
