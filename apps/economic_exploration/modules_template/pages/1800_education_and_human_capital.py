...
# -------------------------------------------------------------------------------------------------
"""
Education & Human Capital — Thematic Indicator Module
--------------------------------------------------------

This module provides a structured decision-support interface for analysing educational systems,
human capital formation, and skill development dynamics within the economy.

It focuses on:

- Education expenditure and enrolment trends (primary, secondary, tertiary)
- Labour force skill indicators and educational attainment
- Optional metrics on literacy, training programs, and human capital indices
...
from indicator_map.indicator_map_1800 import get_indicator_maps

from use_cases.use_case_1800 import get_use_cases, render_use_case_selector

from insights.insight_1800 import generate_econ_insights

from routing.routing_1800 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_1800_education_and_human_capital import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_1800 import (
...
THEME = "education_and_human_capital"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "1800"                # Theme ID
STRUCTURAL_FOLDER = "1800_education_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Education investments, skills development, and workforce capacity signals shaping long-term productivity.*")
