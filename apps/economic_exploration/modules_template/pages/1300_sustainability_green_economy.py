...
# -------------------------------------------------------------------------------------------------
"""
Sustainability & Green Economy — Thematic Indicator Module
-------------------------------------------------------------

This module provides a structured decision-support interface for tracking sustainability metrics,
green investment trends, and environmental-economic transition signals.

It focuses on:

- Renewable energy adoption, carbon emissions, and energy intensity metrics
- Green investment flows, environmental tax trends, and circular economy indicators
- Optional ESG-related macroeconomic signals where available
...
from indicator_map.indicator_map_1300 import get_indicator_maps

from use_cases.use_case_1300 import get_use_cases, render_use_case_selector

from insights.insight_1300 import generate_econ_insights

from routing.routing_1300 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_1300_sustainability_green_economy import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_1300 import (
...
THEME = "sustainability_green_economy"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "1300"                # Theme ID
STRUCTURAL_FOLDER = "1300_sustainability_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Transition dynamics, environmental investments, and green economy structural trends.*")
