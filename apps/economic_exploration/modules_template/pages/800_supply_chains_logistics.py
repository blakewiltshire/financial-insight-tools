...
# -------------------------------------------------------------------------------------------------
"""
Supply Chains & Logistics — Thematic Indicator Module
--------------------------------------------------------

This module provides a structured decision-support interface for assessing supply chain conditions,
logistics performance, and bottleneck or disruption indicators.

It focuses on:
- Freight activity, shipping volumes, and logistics cost indices
- Inventory levels, delivery times, and logistics sentiment measures
- Optional port congestion, supply delay, or global supply stress metrics
...
from indicator_map.indicator_map_800 import get_indicator_maps

from use_cases.use_case_800 import get_use_cases, render_use_case_selector

from insights.insight_800 import generate_econ_insights

from routing.routing_800 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_800_supply_chains_logistics import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_800 import (
...
THEME = "supply_chains_logistics"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "800"                # Theme ID
STRUCTURAL_FOLDER = "800_supply_chain_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Global supply chain disruptions, logistics flows, and material availability risks.*")
