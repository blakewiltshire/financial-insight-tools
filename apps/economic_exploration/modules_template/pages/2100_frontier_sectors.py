...
# -------------------------------------------------------------------------------------------------
"""
Frontier Sectors — Thematic Indicator Module
-----------------------------------------------

This module provides a structured decision-support interface for examining emergent or
unconventional economic sectors that may influence future growth trajectories or systemic transitions.

It focuses on:

- Next-generation industries (e.g. space economy, quantum tech, synthetic biology)
- Experimental sector indices, venture flow data, and innovation diffusion markers
- Optional horizon scanning indicators for paradigm-shifting technologies
...
from indicator_map.indicator_map_2100 import get_indicator_maps

from use_cases.use_case_2100 import get_use_cases, render_use_case_selector

from insights.insight_2100 import generate_econ_insights

from routing.routing_2100 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_2100_frontier_sectors import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_2100 import (
...
THEME = "frontier_sectors"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "2100"                # Theme ID
STRUCTURAL_FOLDER = "2100_frontier_sectors_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Emerging industries across biotech, AI, space, and advanced computing driving speculative growth.*")
