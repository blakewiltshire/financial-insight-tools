...
STRUCTURAL_FOLDER = "600_financial_conditions_template"   # Primary dataset folder name under /data_sources/
COMPOSITE_FOLDER = "600_credit_cycle_default_template" # Optional second template folder
