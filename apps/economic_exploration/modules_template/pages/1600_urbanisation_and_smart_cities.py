...
# -------------------------------------------------------------------------------------------------
"""
Urbanisation & Smart Cities — Thematic Indicator Module
----------------------------------------------------------

This module provides a structured decision-support interface for assessing patterns of urban growth,
infrastructure expansion, and smart city development across national or regional contexts.

It focuses on:

- Urban population trends, density metrics, and spatial distribution
- Infrastructure investment, housing, transport, and mobility indicators
- Optional smart city adoption metrics (IoT, energy, digital public services)
...
from indicator_map.indicator_map_1600 import get_indicator_maps

from use_cases.use_case_1600 import get_use_cases, render_use_case_selector

from insights.insight_1600 import generate_econ_insights

from routing.routing_1600 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_1600_urbanisation_and_smart_cities import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_1600 import (
...
THEME = "urbanisation_and_smart_cities"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "1600"                # Theme ID
STRUCTURAL_FOLDER = "1600_urbanisation_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Urban growth patterns, infrastructure investment, and smart city development trends.*")
