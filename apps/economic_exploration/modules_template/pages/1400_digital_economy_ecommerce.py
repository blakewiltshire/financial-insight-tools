...
# -------------------------------------------------------------------------------------------------
"""
Digital Economy & E-Commerce — Thematic Indicator Module
------------------------------------------------------------

This module provides a structured decision-support interface for analysing the evolution of digital
economic activity, technology penetration, and e-commerce development.

It focuses on:

- ICT investment, broadband access, and digital infrastructure metrics
- E-commerce sales volumes, platform adoption, and digital payment trends
- Optional indicators on labour digitisation and online service integration
...
from indicator_map.indicator_map_1400 import get_indicator_maps

from use_cases.use_case_1400 import get_use_cases, render_use_case_selector

from insights.insight_1400 import generate_econ_insights

from routing.routing_1400 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_1400_digital_economy_ecommerce import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_1400 import (
...
THEME = "digital_economy_ecommerce"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "1400"                # Theme ID
STRUCTURAL_FOLDER = "1400_digital_economy_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Digital adoption rates, ecommerce flows, and technology-driven consumption shifts.*")
