...
# -------------------------------------------------------------------------------------------------
"""
Geopolitical Risks & Global Stability — Thematic Indicator Module
--------------------------------------------------------------------

This module provides a structured decision-support interface for tracking geopolitical risks,
institutional volatility, and macro-level global stability signals.

It focuses on:
- Political risk indices, conflict metrics, and global stability ratings
- Institutional capacity, governance indicators, and regime volatility signals
- Optional coverage of cross-border tensions, sanctions, and regional instability
...
from indicator_map.indicator_map_2000 import get_indicator_maps

from use_cases.use_case_2000 import get_use_cases, render_use_case_selector

from insights.insight_2000 import generate_econ_insights

from routing.routing_2000 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_2000_geopolitical_risks_and_global_stability import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_2000 import (
...
THEME = "geopolitical_risks_and_global_stability" # Theme (file lookup, visuals, AI bundles)
THEME_ID = "2000"                # Theme ID
STRUCTURAL_FOLDER = "2000_geopolitical_risk_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Conflict risks, sovereign credit conditions, and international political tensions affecting global markets.*")
