...
# -------------------------------------------------------------------------------------------------
"""
Innovation, R&D, and Investment — Thematic Indicator Module
---------------------------------------------------------------

This module provides a structured decision-support interface for evaluating national innovation capacity,
research intensity, and capital allocation into technological advancement.

It focuses on:

- R&D expenditure, patent activity, and high-tech sector share
- Venture capital flows, startup formation, and innovation financing
- Optional metrics on knowledge diffusion, innovation outputs, and industrial scaling
...
from indicator_map.indicator_map_1500 import get_indicator_maps

from use_cases.use_case_1500 import get_use_cases, render_use_case_selector

from insights.insight_1500 import generate_econ_insights

from routing.routing_1500 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_1500_innovation_rd_investment import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_1500 import (
...
THEME = "innovation_rd_investment"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "1500"                # Theme ID
STRUCTURAL_FOLDER = "1500_innovation_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Research activity, patent pipelines, and capital flows into disruptive innovation sectors.*")
