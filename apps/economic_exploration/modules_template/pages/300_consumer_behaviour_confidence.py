...
# -------------------------------------------------------------------------------------------------
"""
Consumer Behaviour Confidence — Thematic Indicator Module
--------------------------------------------------------

This module provides a structured decision-support interface for analysing household behaviour,
consumer sentiment, and spending dynamics.

It focuses on:

- Retail sales, household consumption, and discretionary spending indicators
- Consumer confidence indices, expectations, and survey-based sentiment data
- Supplementary variables such as credit growth, saving ratios, and spending composition
...
from indicator_map.indicator_map_300 import get_indicator_maps

from use_cases.use_case_300 import get_use_cases, render_use_case_selector

from insights.insight_300 import generate_econ_insights

from routing.routing_300 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_300_consumer_behaviour_confidence import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_300 import (
...
THEME = "consumer_behaviour_confidence"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "300"                # Theme ID
STRUCTURAL_FOLDER = "300_retail_template"   # Primary dataset folder name under /data_sources/
COMPOSITE_FOLDER = "300_sentiment_template" # Optional second template folder (leave blank if unused)
...
st.caption("*Sentiment, spending patterns, and confidence signals shaping consumer demand.*")
