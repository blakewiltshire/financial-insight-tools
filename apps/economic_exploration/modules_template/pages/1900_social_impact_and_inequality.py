...
# -------------------------------------------------------------------------------------------------
"""
Social Impact & Inequality — Thematic Indicator Module
---------------------------------------------------------

This module provides a structured decision-support interface for examining socio-economic disparities,
inclusion dynamics, and the distributional effects of economic structures.

It focuses on:
- Income inequality and social mobility indicators
- Poverty rates, wage gaps, and access to services
- Optional metrics on regional disparities, gender equality, and financial inclusion
...
from indicator_map.indicator_map_1900 import get_indicator_maps

from use_cases.use_case_1900 import get_use_cases, render_use_case_selector

from insights.insight_1900 import generate_econ_insights

from routing.routing_1900 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_1900_social_impact_and_inequality import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_1900 import (
...
THEME = "social_impact_and_inequality"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "1900"                # Theme ID
STRUCTURAL_FOLDER = "1900_social_inequality_template"   # Primary dataset folder name under /data_sources/
...
st.caption("*Distribution of income, wealth concentration, and social stability risks within and across economies.*")
