...
USE_CASES = {
    "Currency Regime Framework": {
        ...
        "Description": (
            "Tracks trade-weighted currency strength, reserve stability, and current account "
            "support to observe how exchange pressure and external balance interact across "
            "the currency regime."
        )
    }
}
