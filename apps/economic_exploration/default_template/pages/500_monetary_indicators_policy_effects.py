...
STRUCTURAL_FOLDER = "500_interest_rate_template"   # Primary dataset folder name under /data_sources/
COMPOSITE_FOLDER = "500_money_supply_template"   # Optional (leave blank if unused)
