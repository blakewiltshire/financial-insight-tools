...
# -------------------------------------------------------------------------------------------------
"""
🏭 Industry Performance & Production — Thematic Indicator Module
----------------------------------------------------------------

This module provides a structured decision-support interface for tracking industrial output,
sector-level performance, and production cycle dynamics within an economy.

It focuses on:
- Industrial production indices and manufacturing trends
- Sector-specific performance signals (e.g., energy, construction, heavy industry)
- Optional indicators of capacity utilisation, inventories, or production volatility
...
from indicator_map.indicator_map_1200 import get_indicator_maps

from use_cases.use_case_1200 import get_use_cases, render_use_case_selector

from insights.insight_1200 import generate_econ_insights

from routing.routing_1200 import get_indicator_input

from scoring_weights_labels.scoring_weights_labels_1200_industry_performance_production import (
    get_alignment_score_label,
    get_indicator_weight,
)

from visual_config.visual_config_1200 import (
...
THEME = "industry_performance_production"  # Theme slug (used in file lookup, visuals, AI bundles)
THEME_ID = "1200"                # Theme ID
STRUCTURAL_FOLDER = "1200_pmi_template"   # Primary dataset folder name under /data_sources/
COMPOSITE_FOLDER = "1200_industrial_production_template"  # Optional
...
st.caption("*Industrial output levels, capacity utilization, and production cycle indicators.*")
