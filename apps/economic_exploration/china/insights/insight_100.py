...
# -------------------------------------------------------------------------------------------------
# This module acts as the insight dispatcher for macroeconomic signals related to
# the Economic Growth & Stability thematic grouping.
#
# It optionally extends the universal insight engine with country-specific messages.
# This ensures consistent override capability while preserving fallback resilience.
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
# 🧠 Local Insight Definitions (Optional Overrides)
# -------------------------------------------------------------------------------------------------
LOCAL_INSIGHTS = {
    # Example structure for optional local customisation:
    # "Macro Indicator Name": {
    #     "Signal Label": "Custom insight text",
    #     "Contradictory Signal": "Country-specific commentary"
    # }
}
