...
DATASET_REGISTRY = {
    ...
    "df_daily_credit": {
        "label": "📄 Credit Conditions and Financing Pressure",
        "file": f"{COUNTRY_CODE}_d_{THEME_ID}_structural.csv",
    ...
    "df_weekly_credit": {
        "label": "📄 Bank Balance Sheet Liquidity and Credit Capacity",
        "file": f"{COUNTRY_CODE}_w_{THEME_ID}_structural.csv",
        "folder": "600_credit_conditions",
        "frequency": "weekly",
        "cleaner": clean_economic_data,
    ...
    "df_weekly_sovereign": {
        "label": "📄 Sovereign Financing Conditions",
        "file": f"{COUNTRY_CODE}_w_{THEME_ID}_structural.csv",
    ...
    "df_quarterly_sovereign": {
        "label": "📄 Sovereign Debt Structure",
    ...
    "df_annual_sovereign": {
        "label": "📄 Sovereign Fiscal Structure",
...
df_dict = {
    ...
    "df_daily_credit_slice": df_daily_credit_slice,
    "df_weekly_credit_slice": df_weekly_credit_slice,
    "df_weekly_sovereign_slice": df_weekly_sovereign_slice,
    "df_quarterly_sovereign_slice": df_quarterly_sovereign_slice,
    "df_annual_sovereign_slice": df_annual_sovereign_slice
}
...
df_map = {
    ...
    "df_daily_credit": df_daily_credit,
    "df_weekly_credit": df_weekly_credit,
    "df_weekly_sovereign": df_weekly_sovereign,
    "df_quarterly_sovereign": df_quarterly_sovereign,
    "df_annual_sovereign": df_annual_sovereign
}
