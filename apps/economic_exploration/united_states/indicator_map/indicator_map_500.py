...
# Imports — Universal Indicator Maps
# -------------------------------------------------------------------------------------------------
from universal_indicator_map_500 import (
...
# -------------------------------------------------------------------------------------------------
ALL_INDICATOR_MAPS = {
    "Money Supply and Velocity Dynamics": options_money_supply_and_velocity_dynamics_map,
    "Interest Rate Regime and Transmission": options_interest_rate_regime_and_transmission_map,
}
