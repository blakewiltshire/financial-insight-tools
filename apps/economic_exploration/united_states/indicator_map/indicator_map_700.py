...
# Imports — Universal Indicator Maps
# -------------------------------------------------------------------------------------------------
from universal_indicator_map_700 import (
...
# -------------------------------------------------------------------------------------------------
ALL_INDICATOR_MAPS = {
    "Country External Balance": options_country_external_balance_map,
    "External Constraint Capital Flow": options_external_constraint_capital_flow_map,
}
