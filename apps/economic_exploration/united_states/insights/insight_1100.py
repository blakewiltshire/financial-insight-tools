...
# -------------------------------------------------------------------------------------------------
from universal_insights_1100 import generate_universal_econ_insights

# -------------------------------------------------------------------------------------------------
# Local Insight Definitions
# -------------------------------------------------------------------------------------------------
LOCAL_INSIGHTS = {
    "Equity Market Value Position": {
        "Aggregate Equity Value Elevated": {
            "bias": "Growth Supportive",
            "text": (
                "Aggregate equity market value is running above its recent trend, suggesting "
                "firmer equity positioning within the broader market structure."
            ),
        },
        "Aggregate Equity Value Stable": {
            "bias": "Neutral",
            "text": (
                "Aggregate equity market value is broadly stable relative to recent norms, "
                "indicating limited recent change in broad market positioning."
            ),
        },
        "Aggregate Equity Value Softening": {
            "bias": "Contraction Warning",
            "text": (
                "Aggregate equity market value is easing relative to recent trend, which may "
                "suggest softer equity positioning within the wider allocation backdrop."
            ),
        },
    },

    "Economy Wide Liability Structure": {
        "Liability Structure Expanding": {
            "bias": "Contraction Warning",
            "text": (
                "Economy-wide liabilities are expanding relative to recent norms, suggesting "
                "a heavier liability structure across the broader financial backdrop."
            ),
        },
        "Liability Structure Stable": {
            "bias": "Neutral",
            "text": (
                "Economy-wide liabilities are broadly stable, indicating limited recent change "
                "in the wider liability structure."
            ),
        },
        "Liability Structure Easing": {
            "bias": "Growth Supportive",
            "text": (
                "Economy-wide liabilities are easing relative to recent norms, suggesting "
                "some moderation in the broader liability backdrop."
            ),
        },
    },
    ...
    "Aggregate Equity Allocation Ratio": {
        "Equity Allocation Share Elevated": {
            "bias": "Growth Supportive",
            "text": (
                "The aggregate equity allocation ratio is strengthening relative to recent "
                "norms, suggesting a larger share of the combined equity-and-liability structure "
                "is being accounted for by equity market value."
            ),
        },
        "Equity Allocation Share Stable": {
            "bias": "Neutral",
            "text": (
                "The aggregate equity allocation ratio is broadly stable, indicating limited "
                "recent change in long-cycle allocation balance between equity value and "
                "economy-wide liabilities."
            ),
        },
        "Equity Allocation Share Softening": {
            "bias": "Contraction Warning",
            "text": (
                "The aggregate equity allocation ratio is easing relative to recent norms, "
                "suggesting equity market value is accounting for a smaller share of the "
                "combined equity-and-liability structure."
            ),
        },
    },
}
