...
# -------------------------------------------------------------------------------------------------
from universal_use_cases_1000 import get_use_cases as get_universal_use_cases
...
USE_CASES.update({
    "Dollar Strength and Global Transmission": {
        ...
        "Description": (
            "Tracks dollar strength, trade-weighted dollar pressure, and wider cross-market "
            "transmission to observe how changes in the dollar regime propagate across the system."
        )
    }
})
