# -------------------------------------------------------------------------------------------------
# Observation Handler — Trade Timing and Confirmation
# -------------------------------------------------------------------------------------------------
...
MODULE_TYPE = "trade_portfolio_structuring/trade_timing"
FIXED_FILENAME = "default__trade_timing__user_observations.csv"
