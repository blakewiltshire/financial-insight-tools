# -------------------------------------------------------------------------------------------------
# Observation Handler — Market & Volatility Scanner
# -------------------------------------------------------------------------------------------------
...
MODULE_TYPE = "trade_portfolio_structuring/market_scanner"
FIXED_FILENAME = "default__market_scanner__user_observations.csv"
