...
MODULE_TYPE = "intermarket_correlation"
FIXED_FILENAME = "default__relative_macro_transmission__user_observations.csv"
    ...
    with st.form(form_key):
        ...
        if submitted and observation_text.strip():
            save_observation(
                ...
                additional_context={
                    "use_case": st.session_state.get("rmt_use_case"),
                },
