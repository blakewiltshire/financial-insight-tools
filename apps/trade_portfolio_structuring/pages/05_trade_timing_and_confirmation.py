...
# -------------------------------------------------------------------------------------------------
# Observation Engine — User Logging
# -------------------------------------------------------------------------------------------------
from observation_handler_trade_timing import (
...
from macro_insight_sidebar_panel_trade_timing import render_macro_sidebar_tools

# -------------------------------------------------------------------------------------------------
# AI Export Tools — Trade Timing (Group A)
# -------------------------------------------------------------------------------------------------
from ai_export_ui_panel_trade_timing import render_ai_export_panel
...
if show_ai_export:
    render_ai_export_panel(
        ...
        metadata_lookup=TRADE_TIMING_METADATA,
